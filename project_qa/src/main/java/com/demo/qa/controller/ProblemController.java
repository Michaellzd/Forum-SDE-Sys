...
import com.demo.qa.pojo.Problem;
import com.demo.qa.service.ProblemService;
...
public class ProblemController {
	...
	public Result newlist(@PathVariable String label,@PathVariable int page,@PathVariable int  size){
		...
		return new Result(true,StatusCode.OK,"good", new PageResult<Problem>(pagedata.getTotalElements(),pagedata.getContent()));
	}
